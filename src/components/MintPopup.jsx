...
import {
  CharacterContract,
  EternalProxyContract,
  webaverseGenesisAddress,
} from "./Contract"
...
export default function MintPopup({ templateInfo }) {
  ...
  const mintAsset = async (avatar) => {
    if (true) {
      ...
      const glbHash = await saveFileToPinata(glb, glbName)
              ...
              params: {
                ...
                args: {
                  ...
                  token_metadata: {
                    ...
                    media: `https://gateway.pinata.cloud/ipfs/${glbHash.IpfsHash}`,
                  },
      ...
      <div className={styles["StyledPopup"]}>
        ...
        <Fragment>
          ...
          <div className={styles["MintPriceBox"]}>
            <div className={styles["MintCost"]}>{"Mint Price: "}</div>
            <div className={styles["TraitImage"]} />
            <img src={nearIcon} height={"50%"} />
            <div className={styles["MintCost"]}>&nbsp;{mintCost}</div>
          </div>
